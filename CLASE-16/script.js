//const nombres = ['Pepe','Juan', 'Carola','Pedro'];
/*
for(let i = 0; index < nombres.length ; i++){
...
console.log('La sumatoria de las edades es: '+sumaEdades);
*/
...
const productosConPrecioInferior = productos.filter(function(producto){
    return producto.precio < 2950
});
console.log(productosConPrecioInferior)

const productosDeMarcaNoblex = productos.filter(function(producto){
    return producto.marca === 'noblex'
});
console.log(productosDeMarcaNoblex)

const productoQueIncluyanElStringTv = productos.filter(function(producto){
    return producto.nombre.toLowerCase().includes('tv'.toLowerCase());
});
console.log(productoQueIncluyanElStringTv)
