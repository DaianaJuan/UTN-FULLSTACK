console.log("HOLA LIMÓN!! Llequé");
console.log("TAREA!!!")

console.log((true > true || 9) && Number(Boolean(1)) > 0 || 'pepe')
//console.log(   (false    || 9) &&       Number(true) > 0 || 'pepe') 
//console.log(              9    &&            true        || 'pepe')
//console.log(true)
...
console.log("DETERMINAR EL ORDEN DE LOS NOMBRES")
...
console.log(nombre)
//pepe-pedro-maría-leonel-julieta-julieta-pedro-pepe
...
console.log(nom)
{
    ...
    }
    {
        ...
        console.log(nom)
        {
            //nom = 'julieta' //NO SE PUEDE REASIGNAR PORQUE ES UNA CONSTANTE
            console.log(nom)
        }
        console.log(nom)
    }
...
console.log(nom)
//pepe-pedro-maria-leonel-leonel-leonel-pedro-pepe


console.log("Probando probando-----")

const anio = 1992
const edad = (2024 - anio)
let nomb = "Dai🤦‍♀️"
console.log(nomb+" tiene "+edad+" años. Nació en "+anio)
{
    const anio = 1990
    const edad = (2024 - anio)
    let nomb = "Leo🥪"
